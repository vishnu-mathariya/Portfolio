      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal className="mb-16">
          <div className="inline-block">
            <span className="text-blue-400 text-xs sm:text-sm font-bold uppercase tracking-widest">
              About Me
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <ScrollReveal animation="fadeInLeft" className="space-y-6">
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              ...
              React.js, Next.js, and component-based architecture.
            </p>

            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              I&apos;m driven by performance optimization, reusable components,
              and cross-device compatibility. I have a strong understanding of
              Agile development, version control with Git, and collaborating
              with cross-functional teams. When I&apos;m not coding, I&apos;m
        ...
        <ScrollReveal
          delay={0.4}
          className="mt-16 md:mt-24 pt-12 md:pt-16 border-t border-purple-500/20"
        >
